...
route.post('/createRemittance', validate(remittanceValidation.createRemittance), remittanceController.createRemittance);
...
route.get('/getRemittancies', remittanceController.getRemittancies);
